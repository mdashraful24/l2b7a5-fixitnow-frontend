        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <Link
                        ...
                        className="mb-2 inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-primary transition-colors"
                    >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="rounded-xl border bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-1 text-sm text-gray-500">{booking.service?.description}</p>
                ...
                <div className="rounded-xl border bg-white p-6 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-gray-900">{booking.technician?.user?.name}</p>
                            <p className="text-sm text-gray-500">{booking.technician?.user?.email}</p>
                            {booking.technician?.user?.phone && (
                                <p className="text-sm text-gray-500">{booking.technician.user.phone}</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 text-sm">
                        ...
                        {booking.availableSlot && (
                            <div className="rounded-lg bg-gray-50 px-4 py-3">
                                <p className="text-xs font-medium text-gray-500 mb-1">Slot Window</p>
                ...
                <div className="rounded-xl border bg-white p-6 shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                        ...
                        <div>
                            ...
                            <p className="mt-1 font-mono text-xs text-gray-400">{booking.id}</p>
                        </div>
                    </div>
                </div>
            </div>
