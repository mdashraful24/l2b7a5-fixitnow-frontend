    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 dark:border-border bg-white dark:bg-card p-6 shadow-sm">
                <div className="mb-1 h-6 w-64 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
                <div className="mb-4 h-4 w-80 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {[1, 2].map((i) => (
                        <div key={i} className="flex flex-col rounded-xl border-2 border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="rounded-xl border border-gray-200 dark:border-border bg-white dark:bg-card p-6 shadow-sm">
                <div className="mb-1 h-6 w-48 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
                <div className="mb-4 h-4 w-96 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
            ...
            <div className="rounded-xl border border-gray-200 dark:border-border bg-white dark:bg-card p-6 shadow-sm">
                ...
                <div className="space-y-4">
                    <div>
                        <div className="mb-1.5 h-4 w-32 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
                        <div className="h-20 w-full animate-pulse rounded-lg bg-gray-200 dark:bg-gray-700" />
                    </div>
                    <div>
                        <div className="mb-1.5 h-4 w-24 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
